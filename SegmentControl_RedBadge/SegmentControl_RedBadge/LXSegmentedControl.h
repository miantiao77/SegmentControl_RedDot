...
@protocol LXSegmentControlDelegate <UIBarPositioningDelegate>
@end
@interface LXSegmentedControl : UIControl <UIBarPositioning, UIAppearance>

/** The control's delegate object, conforming to the UIBarPositioning protocol. */
@property (nonatomic, weak) id <LXSegmentControlDelegate> delegate;
...
/**
 ...
 @returns A LXSegmentedControl object or nil if there was a problem in initializing the object.
 */
...
/**
 Whether to show did not read the red dot
 */
- (void)isNeedShowRedCircle:(NSArray *)unReadList;
/**
 Whether to show did not read Count
 */
